...
def mock_message_extractor():
    ...
    extractor = Mock()
    extractor.extract_metadata = Mock(return_value={
        "message_id": 123,
...
class TestMessageProcessorImageProcessing:
    ...
    async def test_process_image_message_success(
        ...
        with patch.object(message_processor, '_download_image', return_value='bet_12345_999.jpg') as mock_download, \
             patch.object(message_processor, '_upload_to_notion', return_value='notion-file-123') as mock_upload:
...
class TestMessageProcessorResponseFormatting:
    ...
    def test_format_success_response_with_forwarding(
        ...
        message_data = {
            "forwarding": {
                "is_forwarded": True,
                "origin_info": {
                    "origin_sender_name": "Original Sender"
                }
            }
        }
    ...
    def test_get_user_name_with_username_only(
        self,
        message_processor
    ):
