...
class TestUpdateBetStatusUseCase:
    ...
    @pytest.mark.asyncio
    async def test_update_bet_status_invalid_transition(self, use_case, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_update_bet_status_invalid_status_string(self, use_case, mock_repository):
