...
class TestIBetRepository:
    ...
    @pytest.mark.asyncio
    async def test_save_bet_returns_id(
        self, bet_repository: IBetRepository, sample_bet_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_existing_bet(
        self, bet_repository: IBetRepository, sample_bet_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_status_existing_bet(
        self, bet_repository: IBetRepository, sample_bet_data
    ):
