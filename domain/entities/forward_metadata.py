...
class ForwardMetadata:
    ...
    @classmethod
    def create_from_message_data(cls, message_data: dict) -> Optional['ForwardMetadata']:
        """
        ...
        is_private = bool(
            origin_info.get("origin_sender_name") and
            not origin_info.get("origin_sender_user_id")
        )
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "forward_date": self.forward_date.isoformat() if self.forward_date else None,
